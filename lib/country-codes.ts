...
/* Complete dialing-code list for the phone-number selector. Flags are unicode
   emoji (regional-indicator pairs), so no image assets are needed. Sorted
   alphabetically by country name; the picker defaults to the United States. */
export const countryCodes: CountryCode[] = [
  ...
  { name: "Antigua and Barbuda", iso: "AG", dial: "+1", flag: "🇦🇬" },
  ...
  { name: "Congo (DRC)", iso: "CD", dial: "+243", flag: "🇨🇩" },
  ...
  { name: "Saint Kitts and Nevis", iso: "KN", dial: "+1", flag: "🇰🇳" },
  { name: "Saint Lucia", iso: "LC", dial: "+1", flag: "🇱🇨" },
  { name: "Saint Martin", iso: "MF", dial: "+590", flag: "🇲🇫" },
  { name: "Saint Vincent and the Grenadines", iso: "VC", dial: "+1", flag: "🇻🇨" },
